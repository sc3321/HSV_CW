...
lemma cost_factorise_linear_simp: "cost_factorise c \<le> 3 * area c + 1"
  apply (induction c rule: cost_factorise.induct)
                 apply auto
  done

theorem factorise_linear: "\<exists> a b ::nat. cost_factorise c \<le> a * area c + b"
  by (intro exI[of _ 3] exI[of _ 1]) (rule cost_factorise_linear_simp)
